...
import static org.nuxeo.ecm.platform.routing.api.DocumentRoutingConstants.GC_ORPHAN_ROUTES_ACTION_NAME;
 ...
 * @since 2023
 */
public class GarbageCollectOrphanRoutesAction implements StreamProcessorTopology {

    private static final Logger log = LogManager.getLogger(GarbageCollectOrphanRoutesAction.class);

    public static final String ACTION_NAME = GC_ORPHAN_ROUTES_ACTION_NAME;

    @Override
    public Topology getTopology(Map<String, String> options) {
        return Topology.builder()
                       .addComputation(GarbageCollectOrphanRoutesComputation::new,
                               Arrays.asList(INPUT_1 + ":" + ACTION_NAME, //
                                       OUTPUT_1 + ":" + STATUS_STREAM))
                       .build();
    }

    public static class GarbageCollectOrphanRoutesComputation extends AbstractBulkComputation {

        public GarbageCollectOrphanRoutesComputation() {
            super(ACTION_NAME);
        }
